...
class MainActivity : Activity() {
    ...
    override fun onResume(){
        ...
        if (firebaseUser != null ) {
            findViewById<TextView>(R.id.name).text = firebaseUser!!.displayName
            ...
            findViewById<Button>(R.id.signout).apply{
                visibility= View.VISIBLE; setOnClickListener { firebaseAuth!!.signOut();   findViewById<Button>(R.id.signout).visibility = View.GONE }
            }
        }
    }
}
